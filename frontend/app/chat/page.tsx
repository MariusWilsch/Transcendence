  ...
  ?.map((item:User) => (
    ...
    >
      <Group wrap="nowrap" w="100%">
        {item.Avatar && (
          <Center>
            <img src={item.Avatar} alt={item.login} width={50} height={50} className="w-16 h-16 rounded-full p-2" />
          </Center>
        )}
...
export const ConversationNotSelected = () => {
  return (
    <div className="flex  flex-1 flex-col items-center justify-center p-3 my-1  w-screen text-white">
      ...
      <h1 className="text-white"> no Conversation has been selected</h1>
    </div>
  );
}
...
export const Conversations = () => {
  ...
  return (
    <div  className=" flex flex-col h-full p-4 w-full  lg:w-1/5 xl:1/5   text-white space-y-3 rounded border">
      <FindAConversation />
