...
import { setGameData } from '@/app/gamelobby/GlobalRedux/features';
	...
	useEffect(() => {
		const checkJwtCookie = async () => {
			try {
				...
				if (data !== null) {
					//* here's the user data which I need to display on /game page
					setUser(data);
					dispatch(setGameData({ avatar: data.Avatar, username: data.login }));
				}
			} catch (error: any) {
