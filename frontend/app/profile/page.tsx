...
//                 e.target.src = "http://m.gettywallpapers.com/wp-content/uploads/2023/05/Cool-Anime-Profile-Picture.jpg"; // Provide a fallback avatar
//               }}
//             />
//           )}
...
//     // Set a timeout to show the toast after 10 seconds
//     if (!user) {
...
//     // Clean up the timeout if the component unmounts or user becomes available
//     return () => {
